...
TweaksManager.NON_COMPATIBLE_TAGS = ["TR", "TH", "TD", "THEAD", "TBODY", "TFOOT", "CAPTION", "IFRAME"], TweaksManager.SIGNATURE_ACTIVE_ATTRIBUTE = "data-lt-sig-active", TweaksManager.SIGNATURE_ATTRIBUTE = "data-lt-sig", TweaksManager.INLINE_DISPLAY_VALUES = ["inline", "inline-block"], TweaksManager.TEXT_IGNORING_DEFAULT_RULES = new Map([
    ...
    init() {
        Overleaf.init(), TweaksManager.DEFAULT_TWEAKS.init()
    },
    destroy() {
        Overleaf.destroy(), TweaksManager.DEFAULT_TWEAKS.destroy()
    },
    onElement(e) {
        Overleaf.onInputAreaAvailable(e)
    },
    isElementCompatible: e => Overleaf.isEditor(e) || TweaksManager.DEFAULT_TWEAKS.isElementCompatible(e),
    initElement: e => (Overleaf.disableBuiltInValidator(), Overleaf.initPage(e), {
        destroy() {}
    }),
    getInputAreaWrapperTweaks(e) {
        const t = TweaksManager.DEFAULT_TWEAKS.getInputAreaWrapperTweaks(e);
        return {
            createMutationObserver: (e, a) => Overleaf.isEditor(e) ? Overleaf.createMutationObserver(e, a) : t.createMutationObserver(e, a),
            getParsingDetector(e) {
                const a = t.getParsingDetector(e);
                return {
                    isIgnored: t => Overleaf.isEditor(e) ? Overleaf.isElementIgnored(e, t) : a.isIgnored(t),
                    isSignature: e => !1,
                    isQuote: e => !1,
                    getReplacementText: (e, t, a) => "",
                    isBlock: (t, r) => Overleaf.isEditor(e) ? Overleaf.isBlock(e, t, r) : a.isBlock(t, r),
                    isBlockElementRelevant: t => Overleaf.isEditor(e) ? Overleaf.isBlockElementRelevant(e, t) : !!a.isBlockElementRelevant && a.isBlockElementRelevant(t),
                    createMutationObserver: t => Overleaf.isEditor(e) ? Overleaf.createMutationObserver(e, t) : a.createMutationObserver(t),
                    isMutationIgnored: t => Overleaf.isEditor(e) ? Overleaf.isMutationIgnored(e, t) : !!a.isMutationIgnored && a.isMutationIgnored(t),
                    replaceText: (t, r, n) => OverleafRichTextEditor.isEditor(e) ? OverleafRichTextEditor.replaceText(t, r) : a.replaceText(t, r, n),
                    isWhiteSpace: e => a.isWhiteSpace(e)
                }
            },
            getFullTextInfo: (e, t) => Overleaf.getFullTextInfo(e, t),
            getSelectedText: () => Overleaf.getSelectedText() || t.getSelectedText(),
            getSelection: () => Overleaf.getSelection() || t.getSelection()
        }
    },
    getHighlighterTweaks(e, t, a) {
        const r = TweaksManager.DEFAULT_TWEAKS.getHighlighterTweaks(e, t, a);
        return {
            getTargetElement: () => r.getTargetElement(),
            getZIndex: (e, t) => r.getZIndex(e, t),
            addScrollEventListener(t) {
                Overleaf.isEditor(e) ? Overleaf.addScrollEventListener(e, t) : r.addScrollEventListener(t)
            },
            removeScrollEventListener(t) {
                Overleaf.isEditor(e) ? Overleaf.removeScrollEventListener(e, t) : r.removeScrollEventListener(t)
            },
            getVisibleBox: e => r.getVisibleBox(e),
            getScrollableElementSize: t => Overleaf.isEditor(e) ? Overleaf.getScrollableElementSize(e, t) : r.getScrollableElementSize(t),
            getScrollPosition: (t, a, n) => Overleaf.isEditor(e) ? Overleaf.getScrollPosition(e, t, a, n) : r.getScrollPosition(t, a, n),
            createMutationObserver: t => Overleaf.isEditor(e) ? Overleaf.createMutationObserver(e, t) : r.createMutationObserver(t),
            isMutationIgnored: t => Overleaf.isEditor(e) ? Overleaf.isMutationIgnored(e, t) : r.isMutationIgnored(t),
            scrollingThrottleLimit: Overleaf.getScrollingThrottleLimit(e)
        }
    },
    getToolbarAppearance(e) {
        const t = TweaksManager.DEFAULT_TWEAKS.getToolbarAppearance(e);
        return Overleaf.isEditor(e) ? {
            isVisible: (e, t, a) => !0,
            getPosition(e, a, r, n, s, o) {
                const i = t.getPosition(e, a, r, n, s, o);
                return Overleaf.getToolbarPosition(e, n, i)
            },
            getZIndex: (e, a, r) => t.getZIndex(e, a, r),
            getClassName: e => Overleaf.TOOLBAR_CLASS_NAME
        } : TweaksManager.DEFAULT_TWEAKS.getToolbarAppearance(e)
    },
    getDialogAppearance: () => ({
        isPositionVisible: () => !1,
        canDisplayAllSuggestions: () => !1
    }),
    getMaxTextLength: (e, t) => Overleaf.isEditor(e) ? Overleaf.getMaxTextLength(e, t) : TweaksManager.DEFAULT_TWEAKS.getMaxTextLength(e, t),
    getSelectedText: () => Overleaf.getSelectedText() || TweaksManager.DEFAULT_TWEAKS.getSelectedText(),
    getReplacedParts: (e, t) => Overleaf.isEditor(e) ? Overleaf.getReplacedParts(t) : TweaksManager.DEFAULT_TWEAKS.getReplacedParts(e, t),
    shouldUsePartialValidationCaching: e => Overleaf.isEditor(e.inputArea) ? Overleaf.shouldUsePartialValidationCaching(e) : TweaksManager.DEFAULT_TWEAKS.shouldUsePartialValidationCaching(e),
    getValidationOptions: (e, t) => Overleaf.isEditor(e.inputArea) ? Overleaf.getValidationOptions(e, t) : TweaksManager.DEFAULT_TWEAKS.getValidationOptions(e, t),
    filterErrors: (e, t, a) => Overleaf.isEditor(e.inputArea) ? Overleaf.filterErrors(t, a) : TweaksManager.DEFAULT_TWEAKS.filterErrors(e, t, a),
    applyFix: e => Overleaf.isEditor(e.editor.inputArea) ? Overleaf.applyFix(e) : TweaksManager.DEFAULT_TWEAKS.applyFix(e),
    persistTemporarySettings: () => !0,
    getEditorGroupId: e => Overleaf.getDocId(e) || TweaksManager.DEFAULT_TWEAKS.getEditorGroupId(e)
}, {
    match: {
